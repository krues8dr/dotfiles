# Generated by Powerlevel10k configuration wizard on 2019-08-27 at 19:13 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=37
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND=37
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=$POWERLEVEL9K_BASIC_FOREGROUND
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=$POWERLEVEL9K_BASIC_FOREGROUND
